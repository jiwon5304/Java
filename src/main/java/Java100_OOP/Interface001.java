...
class Person_5 {
    ...
    // Constructor
    Person_5() {}
    Person_5 (String name, int age, int weight ) {
        this.name = name;
        this.age = age;
        this.weight = weight;
    }
...
//    void wash() {System.out.println("씻다");}         // 에러: 인터페이스는 일반메소드 사용 불가
...
// Student 클래스(자식)
class Student extends Person_5 implements Allowance, Train {        // ! extendsd 이 implements 보다 먼저 선언되어야 함!
    // Field
